...
class Thread10 extends Thread {
    public void run() {
        ...
        synchronized (DeadLockEx.lock1) {
            ...
            System.out.println("Thread10: Incercarea de a acapara monitorul obiectului lock2");
            synchronized (DeadLockEx.lock2) {
                System.out.println("Thread10: Monitorul obiectulelor lock1" + " si lock2 a fost acaparet");
